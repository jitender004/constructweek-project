...
export const Cart = () => {
    ...
    async function getUserShippingDetails() {
        try{
            const response = await axios.get(`https://bluefly-api.herokuapp.com/user/${id}`);
    ...
    async function getData(){
        const response = await axios.get(`https://bluefly-api.herokuapp.com/product/${id}`);
    ...
    return(
        <Box display='flex' height='1300px'>
                <Box display='flex' flexDirection='column' pl={{lg:'8%'}} pt={{lg:'5%'}} mr={{lg:'3%'}}>
                    <Box>
                        <Link to='#'>
                            <Image
                                height='40px'
                        ...
                        <TableContainer >
                            <Table variant='simple' size='md'>
                                ...
                                <Tr>
                                    ...
                                    <Td>Ashoka Metropolitian, 6-3-2 Road No.1,. Street 3, Banjara Hills, Hyderabad</Td>
                                    <Td ><Link to='#'> Change </Link></Td>
                                </Tr>
                                <Tr>
                    ...
                    <Box  mt={{lg:'12%'}}>
                        ...
                        <Box mt={{lg:'4%'}} w='600px' borderRadius='8px'>
                            ...
                            <Stack spacing={5} border='1px solid #cdcdcd' borderRadius={5}>
                                <Radio pl='7' pt='3' fontWeight='bold' colorScheme='blackAlpha'>Credit card</Radio>
                                <borderBottom ></borderBottom>
                                <Center><Input _focus={{outline:'black', borderColor:'black'}} w='90%' placeholder='Card number' /></Center>
                                <Center><Input _focus={{outline:'black', borderColor:'black'}} w='90%' placeholder='Name on card' /></Center>
                                <Center>
                                    <Grid w='90%' templateColumns='repeat(2, 1fr)' gap={5}>
                                        <GridItem w='100%' ><Input _focus={{outline:'black', borderColor:'black'}} mb='5' placeholder='Expiration date (MM / YY)' /></GridItem>
                                        <GridItem w='100%' ><Input _focus={{outline:'black', borderColor:'black'}} mb='5' placeholder='Security code' /></GridItem>
                                    </Grid>
                                </Center>    
                            </Stack>
                            </Box>
                    ...
                    <Box mt={{lg:'12%'}}>
                        ...
                        <Box border='1px solid #cdcdcd' mt='22px' mb='22px' borderRadius='8px'>
                            <Checkbox  p='8px' iconColor='blackAlpha' colorScheme='blackAlpha' spacing={4} size='lg'>Save my information for faster checkout</Checkbox>
                        </Box>
                    </Box>
                    <Box mt={{lg:'3%'}}>
                ...
                <Box display='flex' flexDirection='column' ml={{lg:'3%'}} pt={{lg:'5%'}} bgColor='rgb(250, 250, 250)'>
                    <Box>
                        {newData.map((item) => {
                            return(
                                <>
                                        ...
                                        <HStack spacing='10px'>
                                            ...
                                            <Box  w='340px' h='4.6em' overflow='hidden'>
                                                <VStack align='left' spacing={0}>
                                                    <Text fontSize='md' fontWeight='bold' wordBreak='break-word'>{item.title}</Text>
                                                    <Text color='#737373' fontSize='sm'>{item.size[0]}</Text>
                                                </VStack>
                                            </Box>
                                            <Box pl='1em'>
                            ...
                            <HStack spacing='10px'>
                                ...
                                <Box  w='340px' h='4.6em' overflow='hidden'>
                                    <VStack align='left' spacing={0}>
                                        ...
                                        <Text color='#737373' fontSize='sm'>44/x</Text>
                                    </VStack>
                                </Box>
                                <Box pl='1em'>
                                    <Text fontSize='md' textAlign='right' fontWeight='bold'>
                    ...
                    <Box mt={{lg:'5%'}} mb={{lg:'5%'}}>
                        <HStack spacing='50px'>
                            <Input _focus={{outline:'black', borderColor:'black'}} placeholder='Gift card or discount code' htmlSize={45} width='auto'/>
                            <Box as='button'
                            padding='.85em 1.7em'
                            backgroundColor='#111111'
                            color='white'
                    ...
                    <Box mb={{lg:'5%'}}>
                        <VStack>
                            <HStack spacing='385px'>
                                <Text fontSize='sm' color='#737373'>Subtotal</Text>
                                <Text fontSize='sm' fontWeight='bold'>
                                    {`$ ${ newData.reduce((prev, curr) => prev + curr.price, 0)}`}
                                </Text>
                            </HStack>
                            <HStack spacing='385px'>
                                <Text pr='14px' fontSize='sm' color='#737373'>Shipping</Text>
...
>
 ...
 <Radio size='md' fontWeight='bold'  colorScheme='blackAlpha' value='1'> <Text> Credit card</Text> </Radio>
*/